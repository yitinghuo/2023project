...
""")
# Read the CSV file
file_path = r'C:\Users\SnowPatrol\Desktop\Github_Analysis\Data_Analysis\names_most_pop.csv'
...
st.markdown(
    '<span style="font-size:15px;"> The average popularity of a repository in the data set is 742.765680095382.</span>',
    unsafe_allow_html=True)
st.markdown(
    '<span style="font-size:15px;"> __Key Finding__: The most popular repository is significantly more popular than those that follow, and the average overall is much below.</span>',
    unsafe_allow_html=True)
...
st.markdown(
    "### [Average Popularity by Programming Language](https://drive.google.com/file/d/1O6yax1ct8qw2zJ_rVd4yl7QBd3bY3JaA/view?usp=sharing)")

# Specify the path to your CSV file
average_popularity_by_language_path = r'C:\Users\SnowPatrol\Desktop\Github_Analysis\Data_Analysis\average_popularity_by_language.csv'
...
st.markdown(
    '<span style="font-size:15px;"> __Key Finding__: The most popular repositories have a primary languages commonly associated with documentation.</span>',
    unsafe_allow_html=True)
st.markdown(
    '<span style="font-size:12px;"> Popularity in this case is measured by a sum across the value associated with stars_count,forks_count,watchers,pull_requests, and commit_count.</span>',
    unsafe_allow_html=True)
st.markdown(
    '<span style="font-size:12px;"> *Rows where any of the above values are empty are excluded (only commit_count column has empty cells these are .065 percent of the data).</span>',
    unsafe_allow_html=True)

st.markdown(
    "### [Percent of Repositories Created by Language Over Time](https://drive.google.com/file/d/1Cpks-MrerlyeKUa888Fgvlc8aj9rGqmz/view?usp=sharing)")

top_lang_over_time = r'C:\Users\SnowPatrol\Desktop\Github_Analysis\Data_Analysis\top_lang_pop_over_time.csv'
top_lang_over_time_df = pd.read_csv(top_lang_over_time)

# Melt the DataFrame to make it suitable for Altair
df_melted = pd.melt(top_lang_over_time_df, id_vars=['created_year'], var_name='Programming Language',
                    value_name='Value')
...
st.markdown(
    '<span style="font-size:15px;"> __Key Finding__: There is a clear trend in the fall in the popularity of Ruby from 2009 and the extreme rise in popularity of Python in recent years.</span>',
    unsafe_allow_html=True)
st.markdown(
    '<span style="font-size:12px;"> * I chose to highlight 5 languages that were the most used which showed interesting trends.</span>',
    unsafe_allow_html=True)
...
st.markdown(
    "### [Number of Repositories Created Over Time](https://drive.google.com/file/d/1ek3YMuSprsIheXT-93jpZ1vavjrjabXx/view?usp=sharing)")

# Specify the path to your CSV file
data_path = r'C:\Users\SnowPatrol\Desktop\Github_Analysis\Data_Analysis\repositories_by_year.csv'
...
st.markdown(
    '<span style="font-size:15px;"> __Key Finding__: There is a steady increase since 2009, with a relatively consistent rate, the peak appears to be in 2020. This can be explained by the Covid 19 epidemic which closed people in their homes and was most disruptive during 2020 offering an explaination as to why there was a stark increase and since 2020 there has been a decrease.</span>',
    unsafe_allow_html=True)

st.markdown(
    "### [Average Number of Repositories Created Per Season](https://drive.google.com/file/d/12Tga-F2_DcStsfBuJ_t6YfCAoSsnUzxz/view?usp=sharing)")
# Specify the path to your CSV file
data_path = r'C:\Users\SnowPatrol\Desktop\Github_Analysis\Data_Analysis\average_repositories_by_season.csv'
...
st.markdown(
    '<span style="font-size:15px;"> __Key Finding__: The most repositories are created in the spring and the least are created in the winter, there is no information provided on dates in which users interact with the repositroy this would be itneresting to know as well.</span>',
    unsafe_allow_html=True)
...
st.markdown(
    "### [Average Number of Repositories Created by Month](https://drive.google.com/file/d/1ro52B3Eyf1I4UDG-fDYD5gKhE16WAKKP/view?usp=sharing)")
# Read the CSV file
csv_file_path = r'C:\Users\SnowPatrol\Desktop\Github_Analysis\Data_Analysis\avg_rep_month.csv'
...
st.altair_chart(chart, use_container_width=True)
st.markdown(
    '<span style="font-size:15px;"> The graph of repositories created by season provided more clear insight into trends in the data.</span>',
    unsafe_allow_html=True)

st.markdown(
    "### [Popularity by Number of Languages Used per Repository](https://drive.google.com/file/d/1u90Pqb_mi_ufWC_2JCOq0BAJ7v5TgpcB/view?usp=sharing)")

# Display the plot in Streamlit
st.image(r'C:\Users\SnowPatrol\Desktop\Github_Analysis\Data_Analysis\Screen Shot', use_column_width=True)

st.markdown(
    '<span style="font-size:15px;"> The data processing was too dense to be processed in streamlit to create the plot.</span>',
    unsafe_allow_html=True)
